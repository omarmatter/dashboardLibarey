            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered zero-configuration dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                 ...
                 @foreach ($publishs as $publish)
                      <td> {{$loop->index}}</td>
                            <td class="sorting_1">{{$publish->name}}</td>
                            <td><a href="{{URl('EditePublish/'.$publish->id)}}" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
                            <a href="{{URl('deletePublish/'.$publish->id)}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                             </tr>
                 @endforeach
