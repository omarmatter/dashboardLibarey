    ...
    <div class="card">
        <div class="card-body">
            <div class="form-validation">
                <form class="form-valide" action="{{ URL('book/store') }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                   @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" placeholder="2017-06-04" id="mdate" data-dtp="dtp_XzhwP" name="Release_Date">
                        </div>
                    </div>
