        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered zero-configuration dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                 ...
                 @foreach ($categoreis as $categorey)
                      <td> {{$loop->index}}</td>
                            <td class="sorting_1">{{$categorey->name}}</td>
                             <td><a href="{{URl('EditeCategorey/'.$categorey->id)}}" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
                            <a href="{{URl('deleteCategorey/'.$categorey->id)}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                             </tr>
                 @endforeach
